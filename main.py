...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--experiment', required=True, action='store',
                        type=float, dest='experimentName', default="experiment_log_name", help="experiment name")
    ...
    tr,te,cl = e.DeclareWithData_embedding(classifier, True, args.support, 0, dec_tree_prec, False)
